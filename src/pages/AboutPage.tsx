...
export function AboutPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen pt-20">
      <SEOHead title="About | Zen Aromatic Collection" />
      
      {/* Hero Section */}
      <section className="bg-linen py-24 px-4 text-center">
        <span className="text-xs tracking-[0.3em] uppercase text-sage font-semibold">Our Story</span>
        <h1 className="font-display text-5xl md:text-6xl font-bold text-charcoal mt-3 mb-6">About Zen</h1>
        <p className="text-xl text-olive-grey max-w-3xl mx-auto">
      ...
      <section className="py-20 px-4 bg-ivory">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-display text-3xl font-bold text-charcoal mb-8">Our Mission</h2>
          <p className="text-lg text-olive-grey leading-relaxed mb-6">
            Zen Aromatic was born from a simple desire: to create self-care products that are as good for the earth as they are for the soul. We believe that true luxury lies in simplicity and the restorative power of nature.
          </p>
          <p className="text-lg text-olive-grey leading-relaxed">
      ...
      {/* Values Grid */}
      <section className="py-20 bg-forest text-white px-4">
      ...
      {/* CTA */}
      <section className="py-24 text-center px-4 bg-linen">
        <h2 className="font-display text-4xl font-bold text-charcoal mb-8">Ready to experience Zen?</h2>
        <Link 
          to="/shop" 
          className="inline-block bg-sage text-white px-10 py-4 font-semibold hover:bg-sage-dark transition-colors rounded-sm"
        >

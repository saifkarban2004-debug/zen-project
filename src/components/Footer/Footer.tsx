      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['FAQ', 'Shipping Policy', 'Returns', 'Privacy Policy', 'Terms of Service'].map((link) => (
                <li key={link}>
                  <a href="#" className="text-slate-400 hover:text-white hover:underline transition-colors">
                    {link}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <form className="flex flex-col space-y-3" onSubmit={(e) => e.preventDefault()}>
              <input 
                ...
                className="bg-slate-800 text-white px-4 py-2 rounded-md border border-slate-700 focus:outline-none focus:border-white transition-colors"
                required
              />
              <button 
                type="submit" 
